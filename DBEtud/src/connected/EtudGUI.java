...
public class EtudGUI extends JFrame {

	private JPanel contentPane;
	private JTable table;
	
	public static EtudGUI current;      /* pour sauter d'une fen�tre � l'autre */ 
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					EtudGUI.current = new EtudGUI();
					EtudGUI.current.setVisible(true);
	...
	public EtudGUI() {
		...
		mntmInsert.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				EditForm.current.setTitle("Ins�rer student");
		...
		mntmUpdate.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {				
				if (table.getSelectedRowCount() == 0) { 
					...
					EditForm.current.setTitle("Modifier student");
					EditForm.current.setVisible(true);
				}
			}
		});
